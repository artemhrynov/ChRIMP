...
data = {
    'Base': {
        'Test Ozonolysis': {'Ground-truth': 0, 'Good alternative': 0, 'Bad alternative': 0, 'Not solved': 5},
        'Test Suzuki': {'Ground-truth': 0, 'Good alternative': 1, 'Bad alternative': 4, 'Not solved': 3}
    },
    'Finetuned Ozonolysis': {
        'Test Ozonolysis': {'Ground-truth': 3, 'Good alternative': 1, 'Bad alternative': 0, 'Not solved': 1},
        'Test Suzuki': {'Ground-truth': 0, 'Good alternative': 2, 'Bad alternative': 3, 'Not solved': 3}
    },
    'Finetuned Suzuki': {
        'Test Ozonolysis': {'Ground-truth': 0, 'Good alternative': 0, 'Bad alternative': 0, 'Not solved': 5},
        'Test Suzuki': {'Ground-truth': 4, 'Good alternative': 0, 'Bad alternative': 0, 'Not solved': 4}
    },
    'Finetuned Ozon. + Suzu.': {
        'Test Ozonolysis': {'Ground-truth': 3, 'Good alternative': 0, 'Bad alternative': 0, 'Not solved': 2},
        'Test Suzuki': {'Ground-truth': 4, 'Good alternative': 0, 'Bad alternative': 0, 'Not solved': 4}
    }
}
...
def create_stacked_bars(ax, test_set_name):
    ...
    for category in categories:
        ...
        ax.barh(y_pos, values, height, label=category, 
                left=left, color=colors[category], 
...
# Add overall title
fig.suptitle('Model Performance on both Test Sets', 
